          ...
          <Container>
            <div className="mx-auto max-w-3xl">
              ...
              <div className="py-12 space-y-4">
                ...
                <ol className="list-decimal space-y-2 pl-6 font-sans text-[17px] leading-relaxed text-(--ink)">
              ...
              <GuideSection heading="3. Compare full treatment cost, not just the first number">
                ...
                />
                <p className="font-sans text-[17px] leading-relaxed text-(--ink)">You should ask:</p>
                <GuideBulletList
                  items={[
              ...
              <GuideSection heading="6. Specialist clinic vs national chain">
                ...
                <p className="font-sans text-[17px] leading-relaxed text-(--ink)">Large chains may offer:</p>
                <GuideBulletList
                  items={[
                    "More locations.",
              ...
              <GuideSection heading="The best way to use RTR before booking">
                <p className="font-sans text-[17px] leading-relaxed text-(--ink)">Use the site in this order:</p>
                <ol className="list-decimal space-y-2 pl-6 font-sans text-[17px] leading-relaxed text-(--ink)">
