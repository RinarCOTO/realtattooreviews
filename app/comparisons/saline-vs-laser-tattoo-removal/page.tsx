...
const jumpItems = [
  { label: "How Saline Works", href: "#saline-method" },
  { label: "How Laser Works", href: "#laser-method" },
  { label: "At a Glance", href: "#glance" },
  { label: "Microblading & PMU", href: "#microblading" },
  { label: "Scarring & Pain", href: "#scarring" },
  { label: "Color & Dark Skin", href: "#color-dark-skin" },
  { label: "Cost & Sessions", href: "#cost" },
        ...
        <section className="py-6">
          <Container>
            <div className="mx-auto max-w-3xl">
              ...
              {/* How saline works */}
              <div id="saline-method" className="py-12">
                <SectionHeading>
              ...
              {/* How laser works */}
              <div id="laser-method" className="py-12">
                <SectionHeading>
              ...
              <div id="scarring" className="py-12">
                <SectionHeading>
              ...
              <div id="color-dark-skin" className="py-12">
                <SectionHeading>
