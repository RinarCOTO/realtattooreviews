...
const jumpItems = [
  { label: "How They Work", href: "#how-they-work" },
  { label: "Comparison", href: "#comparison" },
  { label: "Is Pico Better?", href: "#pico-vs-q" },
  { label: "Effectiveness", href: "#effectiveness" },
  { label: "Dark Skin", href: "#dark-skin" },
  { label: "Color Ink", href: "#color-ink" },
  { label: "Sessions & Cost", href: "#sessions" },
        ...
        <section className="py-6">
          <Container>
            <div className="mx-auto max-w-3xl">
              ...
              {/* How they work */}
              <div id="how-they-work" className="py-12">
                <SectionHeading>
              ...
              {/* Is pico better */}
              <div id="pico-vs-q" className="py-12">
                <SectionHeading>
              ...
              {/* Which providers */}
              <div id="providers" className="py-12">
                <SectionHeading>
