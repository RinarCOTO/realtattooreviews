 ...
 * - Brand is "inkOUT" only
 * - No link blocks in the intro (CC RULE: Internal Link Placement)
 * - Related Pages section at the bottom after the editorial note
 *
 * DYNAMIC DATA NOTE:
 * BrandComparisonEvidence renders live cross-city evidence from Supabase.
 * All prose is intentionally static and generic (no hardcoded numbers or rankings).
 * LaserAway currently has ZERO rows in competitor_reviews. Known pending cities:
 * Houston (Galleria, Heights, Pearland), Chicago, Tampa.
 * Component renders LaserAway section as "Review sample pending" until backfill.
 */
        ...
        <Container>
          <div className="mx-auto max-w-2xl divide-y divide-(--line)">
            ...
            <div className="py-12">
              <div className="rounded-xl border border-(--line) bg-(--surface) p-6">
                <p className="font-sans text-[15px] leading-relaxed text-(--muted) m-0">
                  ...
                  (Trans-Epidermal Pigment Release). TEPR lifts ink out through the skin surface
                  rather than shattering it with light.
                </p>
            ...
            <GuideSection heading="Specialist vs Chain: What Type of Provider Fits Your Needs?">
              <p className="font-sans text-[15px] leading-relaxed text-(--muted)">
                The specialist-vs-chain axis is unique to the inkOUT vs LaserAway comparison.
                LaserAway is explicitly a chain where tattoo removal is one offering among many.
              </p>
              ...
              <GuideBulletList
                items={[
                  "Specialist providers like inkOUT trade geographic reach and brand recognition for protocol depth. Fewer locations means fewer users can access the provider without travel.",
                  "Chain providers like LaserAway trade per-clinician tattoo removal depth for breadth of service and access. More locations means wider access but more variable clinician experience on tattoo removal specifically.",
                ]}
              />
            </GuideSection>
            ...
            <GuideSection heading="inkOUT vs LaserAway: Results, Scarring, and Pain">
              <div className="space-y-3">
                {[
                  ...
                  {
                    title: "Scarring risk",
                    body: "Scarring depends on treatment intensity, provider skill, and skin type. PicoSure's picosecond pulse width reduces thermal damage compared to nanosecond Q-switched lasers. TEPR avoids the wavelength-versus-melanin interaction by mechanism. This is relevant to scarring risk for darker skin tones. Ask both providers about scarring rates and protocols at consultation.",
                  },
                  {
                    title: "Pain",
              ...
              <div className="space-y-3">
                {[
                  ...
                  },
                  {
                    ...
                    body: "Cosmetic tattoo inks often contain iron oxides. These can darken paradoxically under laser. This is a known consideration for any laser treatment of microblading, powder brows, lip blush, or eyeliner tattoos. TEPR avoids this risk. It does not use light. inkOUT is structurally well-suited to PMU and microblading cases. LaserAway handles cosmetic cases as well. Ask about the location's specific experience with iron-oxide pigments.",
                  },
                ].map((item) => (
                  <div
                    key={item.title}
            ...
            <GuideSection heading="Cross-City Review Evidence">
              <p className="font-sans text-[15px] leading-relaxed text-(--muted)">
                ...
                have direct review-sample data.
              </p>
              <Suspense
                fallback={
              ...
              >
                <BrandComparisonEvidence
                  brandA="inkOUT"
                  brandB="LaserAway"
                  brandBPendingCities={["Houston", "Chicago", "Tampa"]}
                />
              </Suspense>
              <p className="font-sans text-[15px] leading-relaxed text-(--muted)">
                LaserAway review data is pending in our current dataset. The component above will
                render LaserAway evidence once scrape backfill captures their confirmed locations.
                inkOUT evidence spans the markets where we currently have review-sample data. Consult
                each provider&rsquo;s Google business listing for the most current lifetime review
                counts.
              </p>
            </GuideSection>
            ...
            <div className="py-12">
              <GuideCallout label="Editorial note">
                PicoSure details from Cynosure Lutronic product documentation and PMC4859414
                (Torbeck et al 2016). LaserAway review data pending scrape backfill. inkOUT is a
                current advertising client; see{" "}
                <Link href="/editorial-policy" className="text-(--accent) hover:underline">
                  editorial policy
                </Link>
                . Individual outcomes vary. See{" "}
            ...
            {/* Related Pages */}
            <div className="py-12">
              <p className="font-sans text-[13px] font-semibold uppercase tracking-wider text-(--muted) mb-4">
                Related Pages
              </p>
              <ul className="space-y-2">
                {[
                  ...
                  <li key={link.href}>
                    <Link
                      href={link.href}
                      className="font-sans text-[15px] text-(--accent) hover:underline"
                    >
                      {link.title}
                    </Link>
                  </li>
