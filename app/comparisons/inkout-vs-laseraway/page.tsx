...
const jumpItems = [
  ...
  { label: "Method", href: "#tech" },
  { label: "Specialist vs Chain", href: "#specialist" },
      ...
      <section className="py-6">
        <Container>
          <div className="mx-auto max-w-3xl">
            ...
            {/* Specialist vs Chain */}
            <div id="specialist" className="py-12">
            ...
            <div id="evidence" className="py-12">
              ...
              <div className="space-y-4">
                ...
                >
                  <BrandComparisonEvidence brandA="inkOUT" brandB="LaserAway" />
                </Suspense>
                <p className="font-sans text-[15px] leading-relaxed text-(--ink)">
