  ...
  return (
    <div className="reviews-page">
      ...
      <PageHero
        ...
        title={<>Best Tattoo Removal <span className="text-(--accent)">in Chicago</span></>}
        subtitle="Compare tattoo removal clinics in Chicago and the suburbs. See provider differences across method, reviews, and pricing before you book."
      />
