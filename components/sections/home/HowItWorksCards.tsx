  ...
  return (
    <div ref={ref} className="grid gap-5 sm:gap-8 sm:grid-cols-3">
      {steps.map((step, i) => (
        ...
        >
          <h3 className="font-(family-name:--font-satoshi) text-[15px] font-semibold leading-5 text-heading">{step.title}</h3>
          <div className="mt-2 font-(family-name:--font-inter) text-[14px] font-normal leading-5 text-heading">
