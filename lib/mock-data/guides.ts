export const guides = [
  {
    ...
    description: "What to do between sessions to protect skin, reduce risk of scarring, and support fading. Covers sun protection, wound care, and what to avoid.",
  ...
  },
  {
    ...
    description: "Honest overview of common and uncommon side effects: hypopigmentation, hyperpigmentation, blistering, and scarring risk by skin type.",
    image: "/images/image-test.jpg",
  },
  {
    slug: "tattoo-removal-scarring",
    title: "Tattoo Removal Scarring",
    description: "When scarring happens, why it happens, and how to evaluate providers on their scarring track record before you book.",
    image: "/images/image-test.jpg",
  },
  {
